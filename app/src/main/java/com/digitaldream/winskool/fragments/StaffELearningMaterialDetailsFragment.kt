...
import com.digitaldream.winskool.adapters.AdminELearningCommentAdapter
import com.digitaldream.winskool.adapters.AdminELearningFilesAdapter
import com.digitaldream.winskool.models.AttachmentModel
import com.digitaldream.winskool.models.CommentDataModel
import com.digitaldream.winskool.utils.FileViewModel
...
class StaffELearningMaterialDetailsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_staff_e_learning_material_details, container, false)
    }

    companion object {

        @JvmStatic fun newInstance(data: String, task: String) =
                StaffELearningMaterialDetailsFragment().apply {
    ...
    private fun setUpViews(view: View) {
        ...
        val sharedPreferences = requireActivity().getSharedPreferences("loginDetail",
    ...
    private fun parseAttachmentJson() {
        try {
            if (materialData?.isNotBlank() == true) {
                JSONObject(materialData?:"").let {

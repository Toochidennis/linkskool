...
import com.digitaldream.winskool.models.SharedViewModel
...
class AdminELearningQuestionDashboardFragment :
    Fragment(R.layout.fragment_admin_e_learning_question_dashboard) {
    ...
    companion object {
        ...
        fun newInstance(jsonData: String, taskType: String) =
            AdminELearningQuestionDashboardFragment().apply {
    ...
    private fun setUpViewPager() {
        SectionPagerAdapter(childFragmentManager).apply {
            addFragment(
                AdminELearningQuestionDetailsFragment.newInstance(jsonData ?: "", taskType ?: ""),
                "Question"
            )
            addFragment(

...
import com.digitaldream.winskool.adapters.AdminELearningCreateQuestionAdapter
import com.digitaldream.winskool.dialog.AdminELearningQuestionDialog
import com.digitaldream.winskool.dialog.AdminELearningQuestionPreviewFragment
import com.digitaldream.winskool.models.MultiChoiceQuestion
import com.digitaldream.winskool.models.MultipleChoiceOption
import com.digitaldream.winskool.models.QuestionItem
import com.digitaldream.winskool.models.SectionModel
import com.digitaldream.winskool.models.ShortAnswerModel
import com.digitaldream.winskool.utils.FunctionUtils
import com.digitaldream.winskool.utils.ItemTouchHelperCallback
...
/**
 * StaffELearningQuestionFragment is a Fragment responsible for managing and presenting
 ...
 *
 * Example:
 * val fragment = StaffELearningQuestionFragment.newInstance(jsonData, taskType)
 * supportFragmentManager.beginTransaction()
 *     .replace(R.id.fragment_container, fragment)
 *     .commit()
 *
 * @param data JSON data (optional) containing course details, questions, and settings.
 * @param task Task type (optional) specifying whether the fragment is for editing or settings.
 */
...
class StaffELearningCreateQuestionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_staff_e_learning_create_question,
            container,
            false
        )
    }
    ...
    companion object {
        ...
        fun newInstance(data: String, task: String) =
            StaffELearningCreateQuestionFragment().apply {
        ...
        try {
            parentFragmentManager.commit {
                replace(
                    ...
                    StaffELearningQuestionSettingsFragment.newInstance(
    ...
    private fun onExitQuestion() {
        try {
            ...
            if (!questionData.isNullOrEmpty() && assessmentObject != null
                ...
                val areContentSame = FunctionUtils.compareJsonObjects(assessmentObject, json2)

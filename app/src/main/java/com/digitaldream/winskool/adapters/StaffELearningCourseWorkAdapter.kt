...
import com.digitaldream.winskool.models.ContentModel
...
class StaffELearningCourseWorkAdapter(
    ...
    inner class AssignmentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(assignment: ContentModel) {
            ...
            val date = FunctionUtils.formatDate2(assignment.date, "custom")
            ...
            itemView.setOnClickListener {
                viewOrEditContentDetails(itemView, assignment, "assignment_dashboard")
            }
    ...
    inner class MaterialViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(material: ContentModel) {
            ...
            val date = FunctionUtils.formatDate2(material.date, "custom")
            "Posted $date".let { dateTxt.text = it }

            itemView.setOnClickListener {
                viewOrEditContentDetails(itemView, material, "material_dashboard")
            }
    ...
    inner class QuestionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(question: ContentModel) {
            ...
            val date = FunctionUtils.formatDate2(question.date, "custom")
            "Posted $date".let { dateTxt.text = it }

            menuButtonAction("question", optionBtn, question, itemView, adapterPosition)

            itemView.setOnClickListener {
                viewOrEditContentDetails(itemView, question, "question_dashboard")
            }
        }
    }

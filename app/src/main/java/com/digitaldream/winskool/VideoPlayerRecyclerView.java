...
public class VideoPlayerRecyclerView extends RecyclerView {
        ...
        addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    // There's a special case when the end of the childList has been reached.
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if(!isEndOfList){
            ...
            // if there is more than 2 childList-items on the screen, set the difference to be 1
            ...
            // if there is more than 1 childList-item on the screen
        ...
        // set the position of the childList-item that is to be played

...
import com.digitaldream.linkskool.activities.StaffEnterResult
...
class StaffResultBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(levelId: String, courseId: String, classId: String) =
    ...
    private fun btnActions() {
        ...
        attendanceBtn.setOnClickListener {
            launchActivity("course_attendance", StaffAttendanceActivity::class.java)
        }
